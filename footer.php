	...
	<footer id="colophon" class="site-footer" role="contentinfo">
		<div class="site-info">
			<ul>
						...
						<li><a href="mailto:flatlamb@gmail.com?Subject=Hello"><img src="http://localhost:8888/php_final/wp-content/uploads/2016/04/icon_mail.png"></a></li>
					</ul>
					<div class="copyright">
						<p>Copyright&copy; 2016.  Xianning Cui <br>All Rights Reserved</p>
					</div>
		</div><!-- .site-info -->
	</footer><!-- #colophon -->
</div><!-- #page -->
